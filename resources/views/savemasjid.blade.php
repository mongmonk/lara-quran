    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="post container">
                ...
                <form method="post" action="{{ url('quran/jadwalsholatharian') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group my-2"><label class="text-danger">Foto Masjid (Maks. 2MB)*</label><input type="file" class="form-control" name="img" id="img-upload" accept="image/jpeg,image/png,image/gif" required></div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#img-upload').on('change', function() {
                if (this.files.size > 2097152) { // 2MB in bytes
                    alert("Ukuran file terlalu besar! Harap pilih file di bawah 2MB.");
